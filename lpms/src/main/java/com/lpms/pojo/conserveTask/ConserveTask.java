...
public class ConserveTask {
    ...
    public ConserveTask(int conserveTask_id, String conserveTask_name, String conserveTask_describe,
                        int conserveTask_peopleid, List<Integer> conserveTask_plantid, List<String> conserveTask_plantname,
                        int conserveTask_placeid, Date conserveTask_requiretime, Date conserveTask_completetime,
                        Date conserveTask_createtime, Date conserveTask_updatetime) {
        ...
        this.conserveTask_plantname = conserveTask_plantname;
    ...
    public String toString() {
        return "ConserveTask{" +
                ...
                ", conserveTask_plantname=" + conserveTask_plantname +
    ...
    public List<String> getConserveTask_plantname() {
        return conserveTask_plantname;
    }

    public void setConserveTask_plantname(List<String> conserveTask_plantname) {
        this.conserveTask_plantname = conserveTask_plantname;
    }
